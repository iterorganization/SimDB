...
inputs:
  - uri.py: simdb://simdb.iter.org/123e4567-e89b-12d3-a456-426655440000
  - uri.py: file:///home/user/path/to/a/file1
  - uri.py: imas:///user?shot=10000&run=0
  - uri.py: imas+uda:///TOKAMAK?shot=10000&run=0&server=uda.server.org:56565

# Data and log files.
outputs:
  - uri.py: file:///home/user/path/to/a/file2
  - uri.py: imas:///user?shot=10000&run=1
