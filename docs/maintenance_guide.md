...
| file_validation  | extra_rule_dir           | yes (ids_validator only) | Paths to directory containing additional rulesets used by ids_validator i.e. "./path/to/ruleset_dir_1,/path_to_ruleset_dir_2,etc."                                                                                                                              |
